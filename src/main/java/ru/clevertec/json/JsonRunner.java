...
public class JsonRunner {
    public static void main(String[] args) throws IOException {
        ...
        File jsonParseFromFile = Path.of("src\\main\\resources\\fromJson.json").toFile();
        File jsonParseToFile = Path.of("src\\main\\resources\\toJson.json").toFile();
        ...
        Person personTest = new Person(-123213, null, true, '2', null);
        parser.toJSON(personTest);
